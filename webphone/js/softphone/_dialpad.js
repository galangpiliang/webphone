...
//--        common.WinAPI('API_TestEncoded', function (val_in)
//--        {
//--            var val = val_in;
//--            if (common.isNull(val)) { val = ''; }   val = common.Trim(val);
//--            if (val.indexOf('_BASE64_') === 0)
//--            {
//--                val = common.B64Dec(val);
//--                if (common.isNull(val)) { val = ''; }
//--                val = common.Trim(val);
//--            }
...
//BRANDSTART
        && common.GetConfigInt('brandid', -1) !== 60 // 101VOICEDT500
//BRANDEND
    )
    {
...
// don't display Voicemail if we have custom menus 
    ...
    setTimeout(function ()
    {
//--    if (!global.isdebugversion) { common.StartPresence2(); }
